defmodule Kashimashi.Accounts do
  @moduledoc """
  The Accounts context.
  """

  import Ecto.{Query, Changeset}, warn: false
  alias Kashimashi.Repo
  ...
  def get_current_token(conn) do
    KashimashiWeb.Guardian.Plug.current_token(conn)
  end

  def sign_out(conn) do
    KashimashiWeb.Guardian.Plug.sign_out(conn)
  end

  def get_claims(conn) do
    KashimashiWeb.Guardian.Plug.current_claims(conn)
  end

  def refresh_token(jwt) do
    KashimashiWeb.Guardian.refresh(jwt)
  end

  def get_current_user(conn) do
    KashimashiWeb.Guardian.Plug.current_resource(conn)
  end

  def sign_in_user(conn, user) do
    KashimashiWeb.Guardian.Plug.sign_in(conn, user)
  end
